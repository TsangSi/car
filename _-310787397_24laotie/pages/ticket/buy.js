...
Page({
    ...
    buyBtn: function() {
        var t = this;
        if ("" != t.data.userName) {
            if ("" != t.data.userPhone) return /^1[345789]\d{9}$/.test(t.data.userPhone) ? void ("" != t.data.userAddress ? (wx.showLoading({
                title: "加载中..."
                ...
                wx.request({
                    ...
                    success: function(e) {
                        wx.hideLoading(), 1 == e.status ? wx.showToast({
                            title: "提交成功",
                            icon: "none"
                        }) : console.log(e.msg);
                    }
    ...
    onLoad: function(e) {
        ...
        }), this.data.price = e.price, this.data.goods = e.goods;
    },
